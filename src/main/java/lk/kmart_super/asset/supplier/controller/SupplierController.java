package lk.kmart_super.asset.supplier.controller;
    ...
    public String persist(@Valid @ModelAttribute Supplier supplier, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if (supplier.getId() == null) {
            ...
            if (DBSupplier == null) {
                ...
                supplier.setCode("SUP"+makeAutoGenerateNumberService.numberAutoGen(null).toString());
            } else {
                ...
                supplier.setCode("SUP"+makeAutoGenerateNumberService.numberAutoGen(previousCode).toString());
            }
