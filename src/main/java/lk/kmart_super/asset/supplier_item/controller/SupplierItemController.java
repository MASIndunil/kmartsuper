package lk.kmart_super.asset.supplier_item.controller;
...
import lk.kmart_super.asset.ledger.dao.LedgerDao;
import lk.kmart_super.asset.ledger.entity.Ledger;
import lk.kmart_super.asset.purchase_order.common_model.PurchaseOrderItemLedger;
import lk.kmart_super.asset.supplier.entity.Supplier;
import lk.kmart_super.asset.supplier.service.SupplierService;
...
import lk.kmart_super.asset.supplier_item.service.SupplierItemService;
...
public class SupplierItemController {
    ...
    public PurchaseOrderItemLedger purchaseOrderSupplierItem(@RequestParam("supplierId") Integer supplierId,
        ...
        Supplier supplier = supplierService.findByIdAndItemSupplierStatus(supplierId, ItemSupplierStatus.CURRENTLY_BUYING);
        ...
        System.out.println(supplierItem == null);
        System.out.println(" sasda " + supplierItem.getItem().getRop());
